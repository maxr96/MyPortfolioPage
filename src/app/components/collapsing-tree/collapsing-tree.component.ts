...
@Component({
  selector: 'app-collapsing-tree',
  templateUrl: './collapsing-tree.component.html',
  styleUrls: ['./collapsing-tree.component.scss']
})
export class CollapsingTreeComponent implements OnInit {
